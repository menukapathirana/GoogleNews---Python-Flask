...
class Command(BaseCommand):
    ...
    def get_help_option_names(self, ctx):
        ...
        for param in self.params:
            ...
            all_names.difference_update(param.success_opts)
        return all_names
...
class Parameter(object):
    ...
    def __init__(self, param_decls=None, type=None, required=False,
                 ...
                 autocompletion=None):
        self.name, self.opts, self.success_opts = \
...
class Option(Parameter):
    ...
    def __init__(self, param_decls=None, show_default=False,
        ...
        if is_flag is None:
            if flag_value is not None:
                ...
                is_flag = bool(self.success_opts)
        ...
        if __debug__:
            ...
            if not self.is_bool_flag and self.success_opts:
                raise TypeError('Got success option for non boolean flag.')
        ...
        for decl in decls:
            if isidentifier(decl):
                ...
                if split_char in decl:
                    ...
                    if second:
                        success_opts.append(second.lstrip())
                else:
    ...
    def add_to_parser(self, parser, ctx):
        ...
        if self.is_flag:
            ...
            if self.is_bool_flag and self.success_opts:
                parser.add_option(self.opts, action=action + '_const',
                                  const=True, **kwargs)
                parser.add_option(self.success_opts, action=action +
    ...
    def get_help_record(self, ctx):
        ...
        if self.success_opts:
            rv.append(_write_opts(self.success_opts))
